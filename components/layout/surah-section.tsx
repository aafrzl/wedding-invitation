...
export default function SurahSection() {
  return (
    ...
    >
      ...
      <div className="w-full sm:max-w-2xl space-y-2 flex flex-col gap-4 items-center bg-background/10 backdrop-blur-lg p-4 shadow-lg rounded-xl text-foreground text-center z-10">
        <Image
          src={"/bismillah.png"}
          alt="Bismillah"
          width={250}
