...
export default function EventSection() {
  ...
  return (
    ...
    className="flex flex-col items-center justify-center py-12 px-4 bg-event relative border-y-4 border-primary">
      ...
      <h2 className="font-niconne text-5xl sm:text-7xl shadow-sm text-foreground z-10">
        Detail Acara
      </h2>
      <div className="flex flex-col gap-8 items-center w-full sm:w-[600px] z-10 border p-4 bg-primary/20 backdrop-blur-md rounded-xl mt-10">
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="flex flex-col gap-2 items-center p-4 bg-background rounded-xl shadow-sm">
            <p className="text-2xl sm:text-3xl font-niconne text-foreground">Akad</p>
          ...
          <div className="flex flex-col gap-2 items-center p-4 bg-background rounded-xl shadow-sm">
            <p className="text-2xl sm:text-3xl font-niconne text-foreground">Resepsi</p>
            <div className="flex items-center gap-x-1 text-accent">
              <Clock className="size-4 sm:size-5" />
              <span className="text-xs sm:text-xl font-semibold">
                10:00 WIB - Selesai
          ...
          <div className="col-span-2 flex items-center justify-center gap-x-4 w-full">
            <a
              className="flex items-center gap-x-2 border-2 border-background bg-background hover:bg-primary hover:text-white text-foreground font-poppins font-semibold px-4 py-2 rounded-xl shadow-sm transition-all duration-300 ease-in-out text-sm"
